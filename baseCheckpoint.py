...
st.markdown("""
    ...
    /* Ensure text stays centered in buttons */
    .stButton > button > div {
        display: flex !important;
        justify-content: center !important;
...
st.markdown("""
    <div class="main-header">
        ...
        <h1 style="color: black;">DocuSense</h1>
        <p style="color: black;">Your AI-powered medical data analysis assistant</p>
    </div>
""", unsafe_allow_html=True)
...
if st.session_state.page == "Home":
    ...
    st.markdown("""
    <div class="card">
        <h3>Ask me anything about your medical documents or general health questions</h3>
    </div>
    """, unsafe_allow_html=True)
            ...
            with st.spinner('Thinking...'):
                ...
                <div class="chat-container">
                    ...
                    <div class="chat-message assistant-message">
                        <strong>DocuSense:</strong> {answer}
                    </div>
                </div>
                """, unsafe_allow_html=True)
